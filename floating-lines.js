...
class FloatingLines {
    constructor(container, options = {}) {
        ...
        this.options = {
            ...
            lineCount: [6],
            lineDistance: [5],
            topWavePosition: null,
            middleWavePosition: null,
    ...
    init() {
        ...
        this.renderer = new THREE.WebGLRenderer({ antialias: true, alpha: true }); // Alpha true for transparency if needed
        ...
        if (interactive) {
            ...
            window.addEventListener('mouseleave', this.handlePointerLeave.bind(this));
        }
